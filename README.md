...
## Projects
- Execute .NET Assemblies In-memory and Bypass ETW and AMSI [BetterNetLoader](https://github.com/racoten/BetterNetLoader)
...
- Command and Control Framework in C# and Go (private :P)
